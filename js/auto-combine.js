...
window.LuxeAuto = (function () {
  const PACK_STYLES = {
    luxury: {
      ...
      musicHints: ["Midnight Drive", "Quiet Wealth", "Black Chrome", "Soft Leather"],
      autoMode: "luxury",
      maxClips: 4,
    ...
    viral: {
      label: "Viral Pack",
      musicHints: ["Supercar Anthem", "Garage Flex", "Turbo Night", "Redline Rush"],
      autoMode: "viral",
      maxClips: 5,
      mood: "high energy",
    },
    night: {
      label: "Night Run",
      musicHints: ["Neon District", "City Rain", "Midnight Drive", "Turbo Night"],
      autoMode: "night",
      maxClips: 4,
      mood: "night city",
    },
    cinematic: {
      label: "Cinematic Cut",
      musicHints: ["Airstrip Takeoff", "Desert Mirage", "Villa Sunset", "Ocean Highway"],
      autoMode: "cinematic",
      maxClips: 4,
      mood: "film trailer",
    },
    reels: {
      label: "Reels Ready",
      musicHints: ["Garage Flex", "Gold Coast Pulse", "Supercar Anthem"],
      autoMode: "reels_pack",
      maxClips: 3,
      mood: "short punchy",
    },
